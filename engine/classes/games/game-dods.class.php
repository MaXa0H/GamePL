...
class game_dods
{
	...
	public static function admins_reload($id){
		self::engine ();
		source_engine::admins_reload($id,'/dod/addons/sourcemod/configs/admins.cfg');
	}
	...
	public static function on ( $id )
	{
		...
		$exec .= "./srcds_run -console -game dod";
	...
	{
		self::engine ();
		source_engine::update ( $data , '232290' );
	}
	...
	public static function settings ( $data )
	{
		...
		return source_engine::settings ( $data , "/dod/maps/" );
	}

	public static function fastdl_on ()
	{
		fastdl::data ( 'dod/sound' , 'sound' );
		fastdl::data ( 'dod/models' , 'models' );
		fastdl::data ( 'dod/materials' , 'materials' );
		fastdl::data ( 'dod/maps' , 'maps' );
	}

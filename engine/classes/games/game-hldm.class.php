...
class game_hldm
{
	...
	public static function on ( $id )
	{
		...
		$exec .= "./srcds_run -console -game hl2mp";
	...
	{
		self::engine ();
		source_engine::update ( $data , '232370' );
	}
	...
	public static function settings ( $data )
	{
		...
		return source_engine::settings ( $data , "/hl2mp/maps/" );
	}

	public static function fastdl_on ()
	{
		fastdl::data ( 'hl2mp/sound' , 'sound' );
		fastdl::data ( 'hl2mp/models' , 'models' );
		fastdl::data ( 'hl2mp/materials' , 'materials' );
		fastdl::data ( 'hl2mp/maps' , 'maps' );
	}
}
